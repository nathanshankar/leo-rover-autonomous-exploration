...
def generate_launch_description():
    ...
    # Set gz resource path (so it can find your world files)
    ...
    cmd_vel_params_file = PathJoinSubstitution([
        get_package_share_directory('leo_v1'), 'config', 'twist_mux_params.yaml'
    ])
    ...
    node_ros_gz_bridge = Node(
        ...
        arguments=  [
                    ...
                    '/model/leo/cmd_vel'  + '@geometry_msgs/msg/Twist'   + '@' + 'gz.msgs.Twist',
                    '/model/leo/odometry' + '@nav_msgs/msg/Odometry'     + '[' + 'gz.msgs.Odometry',
                    '/model/leo/scan'     + '@sensor_msgs/msg/LaserScan' + '[' + 'gz.msgs.LaserScan',
                    '/model/leo/tf'       + '@tf2_msgs/msg/TFMessage' + '[' + 'gz.msgs.Pose_V',
                    '/model/leo/imu'      + '@sensor_msgs/msg/Imu'       + '[' + 'gz.msgs.IMU',
                    '/world/empty/model/leo/joint_state' + '@sensor_msgs/msg/JointState' + '[' + 'gz.msgs.Model',
                    'model/leo/image' + '@sensor_msgs/msg/Image' + '[' + 'gz.msgs.Image',
                    '/world/empty/model/leo/link/px150/gripper_link/sensor/depth/depth_image' + '@sensor_msgs/msg/Image' + '[' + 'gz.msgs.Image',
                    '/world/empty/model/leo/link/px150/gripper_link/sensor/color/image' + '@sensor_msgs/msg/Image' + '[' + 'gz.msgs.Image',
                    '/world/empty/model/leo/link/px150/gripper_link/sensor/depth/depth_image/points' + '@sensor_msgs/msg/PointCloud2' + '[' + 'gz.msgs.PointCloudPacked',
                    '/model/leo/battery/linear_battery/state' + '@sensor_msgs/msg/BatteryState' + '[' + 'gz.msgs.Battery',
    ...
    node_tf_lidar= Node(
        ...
        executable='static_transform_publisher',
        name='static_transform_publisher',
        arguments=['0', '0', '0', '0', '0', '0', 'rplidar_link', 'leo/base_link/generic_lidar_sensor'],
    )
